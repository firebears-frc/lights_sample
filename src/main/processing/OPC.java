...
public class OPC
{
  ...
  void led(int index, int x, int y)
  {
    ...
    pixelLocations[index] = x + applet.width * y;
  }
  ...
  public void draw()
  {
    ...
    for (int i = 0; i < numPixels; i++) {
      ...
      int pixel = applet.pixels[pixelLocation];
      ...
      if (enableShowLocations) {
    	  applet.pixels[pixelLocation] = 0xFFFFFF ^ pixel;
      }
    }
  ...
  void dispose()
  {
    ...
    if (output != null) {
    	PApplet.println("Disconnected from OPC server");
    }
    socket = null;
    output = null;
  }
  ...
  void connect()
  {
    ...
    try {
      ...
      PApplet.println("Connected to OPC server");
